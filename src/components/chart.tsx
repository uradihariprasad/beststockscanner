  ...
  return (
    <div ref={wrapRef} className="relative select-none">
      <svg width={width} height={height} className="block">
        ...
        {/* time labels */}
        {Array.from({ length: Math.min(8, n) }).map((_, i) => {
          const idx = Math.floor((i / Math.max(1, Math.min(8, n) - 1)) * (n - 1));
          return (
      ...
      {/* legend */}
      <div className="absolute top-2 left-3 flex items-center gap-3 mono text-[9.5px]">
